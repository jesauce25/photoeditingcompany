                                            ...
                                            <div class="card card-primary card-outline mt-4">
                                                <div class="card-header d-flex justify-content-between align-items-center">
                                                    ...
                                                    <?php if ($hasRedoImages): ?>
                                                                        <div>
                                                                            <button id="toggleRedoFilter" class="btn btn-sm btn-warning">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    if ($hasRedoImages): ?>
                                                                        <div class="alert alert-warning">
                                                                            ...
                                                                            <strong>Attention:</strong> Some images have been marked for redo. Please check the items with the "Redo Required" badge.
                                                                        </div>
                                                    <?php endif; ?>
                                                                                    ...
                                                                                    <table class="table table-striped">
                                                                                        ...
                                                                                        <tbody>
                                                                                            <?php foreach ($images as $index => $image): ?>
                                                                                                                        <tr class="image-row <?php echo (isset($image['redo']) && $image['redo'] == '1') ? 'redo-image' : ''; ?>">
